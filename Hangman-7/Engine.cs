...
internal class Engine
{
    ...
    public void ProcessHighscoreRequest()
    {
        ...
        if (highScoreBoard.GetHighScoreCount() == 0)
        {
            this.userInterface.WriteSingleOutputLine("Scoreboard is empty");
        }
        else
        {
            TopPlayer[] highScorePlayerList = highScoreBoard.HighScores;
            int highScoreCount = highScoreBoard.GetHighScoreCount();
    ...
    private void ProcessWin()
    {
        ...
        bool BetterThanLast = highScoreBoard.IsResultAHighScore(this.currentMistakesCount);
